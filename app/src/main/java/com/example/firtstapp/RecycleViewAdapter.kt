...
class RecycleViewAdapter : RecyclerView.Adapter<RecycleViewAdapter.ViewHoder>() {
    ...
    private  var    cappicals : ArrayList<String> = ArrayList();
    ...
    class ViewHoder constructor(itemView : View) : RecyclerView.ViewHolder(itemView) {
       ...
       fun  bind(cappical : String) {
           val shape = GradientDrawable()
           shape.shape = GradientDrawable.RECTANGLE
           shape.setColor(Color.parseColor("#" + mColors.get(java.util.Random().nextInt(254))))
           textView.setBackground(shape)
           textView.setText(cappical)
       }
    }
